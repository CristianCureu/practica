...
const UpdateDosarPage = () => {
  ...
  const [scanatLivrare, setScanatLivrare] = useState(
      ...
      try {
        ...
        if (!dosarData) {
          return enqueueSnackbar(
            "Acest dosar nu există în baza de date!",
            VariantType.ERROR
          );
        }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        enqueueSnackbar("Dosar updated successfully", VariantType.SUCCESS);
